...
export default function LoginPage() {
  ...
  const { loginWithEmail, connectWithGoogle, connectWithGithub, loading } = useAuth()
      ...
      <div className="hidden lg:flex w-[52%] relative flex-col items-center justify-end pb-32 px-12 rounded-3xl overflow-hidden shadow-2xl h-full">
        ...
        >
          ...
          <motion.div className="space-y-3" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <StepItem number={1} text="Verify your identity" active />
            <StepItem number={2} text="Access your messages" />
            <StepItem number={3} text="Resume conversations" />
          </motion.div>
        </motion.div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-12 lg:py-6 px-4 sm:px-12 lg:px-16 xl:px-24 overflow-y-auto lg:overflow-hidden">
        ...
        >
          <div>
            ...
            <p className="text-white/40 text-sm mt-1">Enter your credentials to access your inbox.</p>
          </div>
